...
class AuroFlightline extends r {
  ...
  static register(name = "auro-flightline") {
    AuroLibraryRuntimeUtils$3.prototype.registerComponent(name, AuroFlightline);
  }
...
AuroLibraryRuntimeUtils$2.prototype.registerComponent('custom-badge', AuroBadge);
...
class AuroFlightSegment extends r {
  ...
  static register(name = "auro-flight-segment") {
    AuroLibraryRuntimeUtils$3.prototype.registerComponent(name, AuroFlightSegment);
  }

  firstUpdated() {
    // Add the tag name as an attribute if it is different than the component name
    AuroLibraryRuntimeUtils$3.prototype.handleComponentTagRename(this, 'auro-flight-segment');
  }
